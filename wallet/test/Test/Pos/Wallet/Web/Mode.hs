...
instance HasLens TxpHolderTag WalletTestContext (GenericTxpLocalData ExplorerExtra) where
...
instance HasConfigurations => MonadTxHistory WalletSscType WalletTestMode where
...
type instance MempoolExt WalletTestMode = ExplorerExtra

instance HasConfigurations => MonadTxpLocal (BlockGenMode ExplorerExtra WalletTestMode) where
